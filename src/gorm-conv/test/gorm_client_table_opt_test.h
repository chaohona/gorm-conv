...
void GORM_ClientTableAccount::SetPbMsg(GORM_PB_Table_account *pbMsg, bool forceSave=false)
{
...
void GORM_ClientTableBag::SetPbMsg(GORM_PB_Table_bag *pbMsg, bool forceSave=false)
{
    this->SetVersion(pbMsg->version(), forceSave);
    this->SetId(pbMsg->id(), forceSave);
    this->SetAllbinary(pbMsg->allbinary(), forceSave);
